...
<style lang="scss" scoped>
  ...
  .input-box {
    ...
    .btn-speech:hover,
    .btn-speech.active {
      background: url('@renderer/assets/images/input-btn-speech-hover.png') no-repeat center center /
        100% 100%;
    }
    .btn-clean {
      background: url('@renderer/assets/images/input-btn-clean.png') no-repeat center center / 100% 100%;
    }
    .btn-clean:hover {
    ...
    .btn-send {
      background: url('@renderer/assets/images/input-btn-send.png') no-repeat center center / 100% 100%;
    }
    .btn-send:hover {
      background: url('@renderer/assets/images/input-btn-send-hover.png') no-repeat center center / 100%
        100%;
    }
  }
